...
c
      print *,"#######################################################"
      print *,"#                                                     #"
      if (powheginput("#noprim").gt.0) then
      mstp(91)=0                !No Primordial kt
      print *,"#                No primordial kt                     #"
      end if
      if (powheginput("#nopileup").gt.0) then
      mstp(131)=0               !No Pile Up
      print *,"#                   No Pile-up                        #"
      end if
      if (powheginput("#nophoton").gt.0) then
      mstj(41)=11
      print *,"#       No photon radiation off partons               #"
      end if
      if (powheginput("#nohadron").gt.0) then
      mstp(111)=0               !No hadronization
      mstp(81)=20               !No Multiple interactions. Force a call to PYEVNW 
      print *,"#               No hadronization                      #"
      end if
